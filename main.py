...
# استيراد ملفات الفيس بوك وانستقرام المنفصلة تماماً
...
def start_command(message):
    ...
    text = (
        ...
        "تم. اختر الأداة المطلوبة:"
    )
    # تم تصحيح parse_mode هنا بحرف 'm' صغير لتجنب الكراش نهائياً
